...
// Ruta al archivo HTML (usar el archivo del tema o el de la raíz)
$html_file_theme = '/var/www/html/wp-content/themes/twentytwentythree-child/homepage_content.html';
$html_file_root = '/var/www/html/wp-content/../homepage_content.html';

// Priorizar el archivo del tema, si no existe usar el de la raíz
$html_file = file_exists($html_file_theme) ? $html_file_theme : $html_file_root;
